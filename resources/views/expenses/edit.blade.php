            ...
            <div class="bg-[#1e2030] border-2 border-[#984063] rounded-[22px] p-10 text-white shadow-2xl">
                ...
                <form method="POST" action="{{ route('expenses.update', $expense->id) }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="title" value="{{ old('title', $expense->title) }}" required placeholder="Groceries, Internet Bill.... "
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div>
                            ...
                            <input type="number" step="0.01" name="amount" value="{{ old('amount', $expense->amount) }}" required placeholder="0.00"
                                class="w-full bg-[#0f1015] border-2 border-[#41436A] rounded-xl px-4 py-3 text-white focus:border-[#FE9677] focus:ring-0 transition-all">
                    ...
                    <div class="flex justify-between items-center pt-6 border-t border-[#41436A]">
                        <a href="{{ route('expenses.show', $expense->id) }}" class="text-gray-400 hover:text-white text-sm font-bold uppercase tracking-widest transition-all">Cancel</a>
                        <button type="submit"
